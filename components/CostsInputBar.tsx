...
interface CostsInputBarProps {
  onAddCost: (newCost: Omit<CostData, 'id'>) => void;
}

export const CostsInputBar: React.FC<CostsInputBarProps> = ({ onAddCost }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
      <h2 className="text-xl font-semibold mb-4 text-blue-600">Adicionar Custo</h2>
